...
# puts search(zombie_apocalypse_supplies,\
# "binoculars") # => true
# puts search(zombie_apocalypse_supplies,\
# "asdf") # => false
...
# ----
total_supplies = (zombie_apocalypse_supplies + \
  other_survivor_supplies).uniq
...
# puts is_extinct?(extinct_animals, "Laysan Crake")
...
def remove_animal(animal_hash, animal)
  animal_hash.each { |key, value|
  if key = animal
    animal_hash.delete(key)
    return [key, value]
  end
  }
  return nil
